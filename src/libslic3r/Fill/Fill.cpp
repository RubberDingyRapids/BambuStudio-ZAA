...
//    bool        	dont_adjust = false;
    ...
    // Only meaningful when pattern == ipGyroid.
...
//		RETURN_COMPARE_NON_EQUAL_TYPED(unsigned, dont_adjust);
        ...
        RETURN_COMPARE_NON_EQUAL_TYPED(unsigned, gyroid_optimized);
		return false;
	}
	    ...
	    for (const Surface &surface : layerm.fill_surfaces.surfaces)
	        if (surface.surface_type == stInternalVoid)
                ...
                bool support_multiline_infill = params.pattern == ipCubic || params.pattern == ipGrid || params.pattern == ipRectilinear || params.pattern == ipStars ||
                                                ...
                                                params.pattern == ipSupportCubic || params.pattern == ipTpmsD || params.pattern == ipTpmsFK;
                ...
                params.gyroid_optimized = (params.pattern == ipGyroid) && bool(region_config.gyroid_optimized);
